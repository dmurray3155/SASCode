...
sqlHeader = "INSERT INTO ca_opp_timing (SYEnd, Subject, Grade, studentId, OppID, oppkey, oppstartdate, oppstatus, oppvalidity, oppcompleteness, oppopportunityNum, oppstatusdate, oppcompleteddate) VALUES\n"
sql.write(sqlHeader)
